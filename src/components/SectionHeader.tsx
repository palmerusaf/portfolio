export const SectionHeader = ({ label }: { label: string }) => (
  <div className='flex px-5 w-screen'>
    <div className='flex items-center p-2 mx-auto mt-4 w-full max-w-xl bg-yellow-300 duration-300 -skew-x-12 shadow-[10px_10px] shadow-pink-500 hacker:skew-x-0 hacker:rounded-sm hacker:border hacker:border-green-500 hacker:bg-black hacker:shadow hacker:shadow-green-500'>
